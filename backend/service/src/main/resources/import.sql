...
insert into wine_meat(wine_id,meat_id) values(1,8)
insert into wine_meat(wine_id,meat_id) values(2,2)
insert into wine_meat(wine_id,meat_id) values(2,6)
insert into wine_meat(wine_id,meat_id) values(2,8)
insert into wine_meat(wine_id,meat_id) values(2,17)
...
insert into wine_meat(wine_id,meat_id) values(3,6)
insert into wine_meat(wine_id,meat_id) values(3,8)
insert into wine_meat(wine_id,meat_id) values(3,11)
insert into wine_meat(wine_id,meat_id) values(4,1)
insert into wine_meat(wine_id,meat_id) values(4,17)
insert into wine_meat(wine_id,meat_id) values(5,3)
insert into wine_meat(wine_id,meat_id) values(5,1)
insert into wine_meat(wine_id,meat_id) values(5,17)
...
insert into wine_sauce(wine_id,sauce_id) values(2,4)
insert into wine_sauce(wine_id,sauce_id) values(2,7)
insert into wine_sauce(wine_id,sauce_id) values(2,18)
insert into wine_sauce(wine_id,sauce_id) values(3,3)
insert into wine_sauce(wine_id,sauce_id) values(3,2)
insert into wine_sauce(wine_id,sauce_id) values(3,5)
insert into wine_sauce(wine_id,sauce_id) values(3,6)
insert into wine_sauce(wine_id,sauce_id) values(3,10)
...
insert into spice(id, name, national_cuisine) values(8,"Limeta","INDIJSKA")
...
insert into wine_spice(wine_id,spice_id) values (2,4)
insert into wine_spice(wine_id,spice_id) values (2,5)
insert into wine_spice(wine_id,spice_id) values (2,6)
insert into wine_spice(wine_id,spice_id) values (2,7)
insert into wine_spice(wine_id,spice_id) values (2,8)
insert into wine_spice(wine_id,spice_id) values (2,9)
insert into wine_spice(wine_id,spice_id) values (2,10)
insert into wine_spice(wine_id,spice_id) values (2,23)
insert into wine_spice(wine_id,spice_id) values (2,24)
...
insert into wine_spice(wine_id,spice_id) values (3,6)
insert into wine_spice(wine_id,spice_id) values (3,4)
insert into wine_spice(wine_id,spice_id) values (3,13)
insert into wine_spice(wine_id,spice_id) values (3,15)
insert into wine_spice(wine_id,spice_id) values (3,23)
insert into wine_spice(wine_id,spice_id) values (3,24)
...
insert into wine_spice(wine_id,spice_id) values (6,11)
