...
insert into meat(id,name,national_cuisine) values(7,"Jagnjetina","INDIJSKA")
insert into meat(id,name,national_cuisine) values(8,"Junece mleveno meso","INDIJSKA")
...
insert into meat(id,name,national_cuisine) values(16,"Kozije meso","MEKSICKA")
...
insert into spice(id, name, national_cuisine) values(11,"Paprika","AMERICKA")
insert into spice(id, name, national_cuisine) values(12,"Cimet","AMERICKA")
insert into spice(id, name, national_cuisine) values(13,"Crni luk","AMERICKA")
insert into spice(id, name, national_cuisine) values(14,"Prah 5 zacina","KINESKA")
insert into spice(id, name, national_cuisine) values(15,"Koren djumbira","KINESKA")
insert into spice(id, name, national_cuisine) values(16,"Ulje od susama","KINESKA")
insert into spice(id, name, national_cuisine) values(17,"Secuanski biber","KINESKA")
insert into spice(id, name, national_cuisine) values(18,"Beli biber","KINESKA")
insert into spice(id, name, national_cuisine) values(19,"Kim","KINESKA")
insert into spice(id, name, national_cuisine) values(20,"Ljute papricice","MEKSICKA")
insert into spice(id, name, national_cuisine) values(21,"Slatka paprika","MEKSICKA")
insert into spice(id, name, national_cuisine) values(22,"Suseni paradajz","MEKSICKA")
